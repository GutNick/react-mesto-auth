    ...
    return (
        <section className="authorization" onSubmit={handleSubmit}>
            ...
            <form className="form authorization__form">
                <input type="email" className="form__input" placeholder="Email" onChange={handleChange} autoComplete="email" required />
                <input type="password" className="form__input" placeholder="Пароль" autoComplete="new-password" id="new-password" onChange={handleChange} required />
